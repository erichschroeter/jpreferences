...
public interface IPreferencePageContainer {
	...
	/**
	 * Adjusts the enable state of the OK button to reflect the state of the
	 ...
	 * this container.
	 * 
	 * This method is called by the container itself when its page changes and
	 * may be called by the page at other times to force a title update.
	 */
	 ...
	 * <code>IPreferencePageContainer</code>'s <code>Window</code>, such is the
	 * case in additional dialog windows (e.g. <code>ColorPicker</code>, <code>JDialog</code>).
	 * </p>
	 * 
